...
This function may use I<selection> as a declaration of what it should expect
to find in I<params>, and to discriminate what is acceptable to import.
...
This function may use I<selection> to discriminate what is acceptable to export.
I<selection> may also be zero, which should be interpreted as "anything goes",
leaving it to the caller to determine what was actually exported.
...
This function may use I<selection> to discriminate what is acceptable to
duplicate.
