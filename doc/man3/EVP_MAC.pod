...
EVP_MAC_name, EVP_MAC_provider,
EVP_MAC_CTX, EVP_MAC_CTX_new, EVP_MAC_CTX_free, EVP_MAC_CTX_dup,
EVP_MAC_CTX_mac, EVP_MAC_CTX_get_params, EVP_MAC_CTX_set_params,
EVP_MAC_size, EVP_MAC_init, EVP_MAC_update, EVP_MAC_final,
EVP_MAC_CTX_get_param_types, EVP_MAC_CTX_set_param_types,
EVP_MAC_do_all, EVP_MAC_do_all_sorted - EVP MAC routines
...
the memory pointed at by I<out>, and sets its size in the B<size_t>
the I<outl> points at.
...
EVP_MAC_CTX_get_params() passes chosen parameters to the underlying
...
=begin comment : this will be back
...
This parameter should be of type B<OSSL_PARAM_OCTET_STRING>
...
this parameter sets the Customization String. The default value is "".
...
This parameter should be of type B<OSSL_PARAM_INTEGER>
...
These parameter should all be of type B<OSSL_PARAM_UTF8_STRING>, and
...
Also note that "algorithm" can be use generically instead of "md",
"digest" or "cipher", and that "md" and "digest" are also
interchangable.
...
These parameter should all be of type B<OSSL_PARAM_UNSIGNED_INTEGER>.
