...
static OSSL_OP_mac_ctx_set_param_types_fn gmac_set_param_types;
static OSSL_OP_mac_ctx_set_params_fn gmac_set_params;
static OSSL_OP_mac_size_fn gmac_size;
...
static size_t gmac_size(void *vmacctx)
{
...
static const OSSL_PARAM *gmac_set_param_types(void)
{
    return known_params;
}
 ...
 */
static int gmac_set_params(void *vmacctx, const OSSL_PARAM params[])
{
    struct gmac_data_st *macctx = vmacctx;
    EVP_CIPHER_CTX *ctx = macctx->ctx;
    const OSSL_PARAM *p;
...
const OSSL_DISPATCH gmac_functions[] = {
    ...
    { OSSL_FUNC_MAC_SIZE, (void (*)(void))gmac_size },
    ...
    { OSSL_FUNC_MAC_CTX_SET_PARAM_TYPES,
      (void (*)(void))gmac_set_param_types },
    { OSSL_FUNC_MAC_CTX_SET_PARAMS, (void (*)(void))gmac_set_params },
    { 0, NULL }
};
