...
static OSSL_OP_mac_ctx_set_param_types_fn poly1305_set_param_types;
static OSSL_OP_mac_ctx_set_params_fn poly1305_set_params;
static OSSL_OP_mac_size_fn poly1305_size;
...
static size_t poly1305_size(void *vmacctx)
{
...
static const OSSL_PARAM *poly1305_set_param_types(void)
{
    return known_params;
}

static int poly1305_set_params(void *vmacctx, const OSSL_PARAM *params)
{
    struct poly1305_data_st *ctx = vmacctx;
...
const OSSL_DISPATCH poly1305_functions[] = {
    ...
    { OSSL_FUNC_MAC_SIZE, (void (*)(void))poly1305_size },
    ...
    { OSSL_FUNC_MAC_CTX_SET_PARAM_TYPES,
      (void (*)(void))poly1305_set_param_types },
    { OSSL_FUNC_MAC_CTX_SET_PARAMS, (void (*)(void))poly1305_set_params },
    { 0, NULL }
};
