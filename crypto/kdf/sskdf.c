                     ...
                     size_t derived_key_len, unsigned char **out)
{
    ...
    params[0] = OSSL_PARAM_construct_octet_string("custom", (void *)custom,
                                                  custom_len);
    ...
    params[0] = OSSL_PARAM_construct_size_t("outlen", &kmac_out_len);
                         ...
                         unsigned char *derived_key, size_t derived_key_len)
{
    ...
    if (hmac_md != NULL) {
        ...
        params[params_n++] =
            OSSL_PARAM_construct_utf8_string("algorithm", (char *)mdname,
                                             strlen(mdname) + 1);
    }
    params[params_n++] =
        OSSL_PARAM_construct_octet_string("key", (void *)salt, salt_len);
