...
static int pkey_mac_signctx_init(EVP_PKEY_CTX *ctx, EVP_MD_CTX *mctx)
{
    ...
    /* Some MACs don't support this control...  that's fine */
    {
        ...
        params[params_n++] = OSSL_PARAM_construct_int("flags", &flags);
        if (set_key)
            params[params_n++] =
                OSSL_PARAM_construct_octet_string("key", key->data,
                                                  key->length);
        ...
        case MAC_TYPE_MAC:
            {
                ...
                params[params_n++] =
                    OSSL_PARAM_construct_utf8_string("engine", engineid,
                                                     strlen(engineid) + 1);
                params[params_n++] =
                    OSSL_PARAM_construct_utf8_string("algorithm", ciphname,
                                                     strlen(ciphname) + 1);
                params[params_n] = OSSL_PARAM_construct_end();
    ...
    case EVP_PKEY_CTRL_SET_DIGEST_SIZE:
        {
            ...
            params[params_n++] =
                OSSL_PARAM_construct_size_t("outlen", &size);
            params[params_n] = OSSL_PARAM_construct_end();
        ...
        case MAC_TYPE_MAC:
            {
                ...
                params[params_n++] =
                    OSSL_PARAM_construct_octet_string("key", p2, p1);
                params[params_n] = OSSL_PARAM_construct_end();
    ...
    case EVP_PKEY_CTRL_DIGESTINIT:
        ...
        case MAC_TYPE_RAW:
                ...
                return 0;
            {
                ...
                params[params_n++] =
                    OSSL_PARAM_construct_utf8_string("algorithm", mdname,
                                                     strlen(mdname) + 1);
                params[params_n++] =
                    OSSL_PARAM_construct_octet_string("key", key->data,
                                                      key->length);
                              ...
                              const char *type, const char *value)
{
    ...
    if (!OSSL_PARAM_allocate_from_text(&params[0],
                                       EVP_MAC_CTX_set_param_types(mac),
